...
public class SearchViewControl implements DisposeListener {
	...
	private class FieldFilterAction extends FilterChangeAction {
		 ...
		 * 
		 */
		protected FilterChangeAction addAction(final DropdownMenuProvider<FilterChangeAction> dropdown,
	...
	public void setContentProposalAdapter(SearchContentProposalProvider provider) {
		...
		ContentProposalAdapter adapter = new SearchContentProposalAdapter(searchText, new StyledTextContentAdapter(),
	...
	private class SearchContentProposalAdapter extends ContentProposalAdapter {
		 ...
		 */
		public SearchContentProposalAdapter(Control control, IControlContentAdapter controlContentAdapter,
				IContentProposalProvider proposalProvider, KeyStroke keyStroke, char[] autoActivationCharacters) {
			super(control, controlContentAdapter, proposalProvider, keyStroke, autoActivationCharacters);
		}

		@Override
		public void closeProposalPopup() { // workaround to keep popup open
