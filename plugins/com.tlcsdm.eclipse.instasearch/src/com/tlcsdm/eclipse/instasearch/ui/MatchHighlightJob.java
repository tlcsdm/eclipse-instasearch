...
import com.tlcsdm.eclipse.instasearch.ui.ResultContentProvider.MatchLine;
...
class MatchHighlightJob extends Job implements ISchedulingRule, IPartListener {
	 ...
	 * @throws Exception
	 */
	public MatchHighlightJob(SearchResultDoc doc, MatchLine selectedLineMatches, ResultContentProvider contentProvider,
			Job searchJob, IWorkbenchPage workbenchPage) throws Exception {
	...
	private class MatchHighliter implements ResultContentProvider.MatchFindCallback {
		 ...
		 */
		protected void highlightMatchLine(IFile file, MatchLine lineMatches)
			...
			if (selectedLineMatches == null)
				selectedLineMatches = lineMatches; // pick first
		...
		private IMarker createMarker(int pos, int lineNumber, Match match, IFile file, ITextEditor textEditor)
				throws CoreException {
