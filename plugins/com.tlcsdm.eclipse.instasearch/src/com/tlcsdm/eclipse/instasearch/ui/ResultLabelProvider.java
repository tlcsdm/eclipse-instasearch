...
class ResultLabelProvider extends LabelProvider implements IStyledLabelProvider, IPropertyChangeListener {
	...
	private static final String HIGHLIGHT_COLOR_NAME = "com.tlcsdm.eclipse.instasearch.ui.HighlightColor";
	...
	public ResultLabelProvider(ResultContentProvider contentProvider) {
		...
		JFaceResources.getColorRegistry().put(HIGHLIGHT_COLOR_NAME,
				(searchColor != null ? searchColor.getRGB() : new RGB(206, 204, 247)));
