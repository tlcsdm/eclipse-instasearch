...
public class InstaSearchView extends ViewPart
	...
	public void modifyText(ModifyEvent e) {
		...
		searchJob.schedule(getSearchQuery(), false, typingSearchDelay); // start with a delay since user might still be
																		// typing
	...
	private void doIncrementalSearch() {
		...
		if (editor != null) {
			...
			if (target != null)
				lastIncrementalSearchPos = target.findAndSelect(lastIncrementalSearchPos, searchText.getText(), true,
						false, false) + searchText.getText().length();
		}
	}
	...
	/**
	 * Logging an error in the plugin Create an action that allows reporting it
	 */
