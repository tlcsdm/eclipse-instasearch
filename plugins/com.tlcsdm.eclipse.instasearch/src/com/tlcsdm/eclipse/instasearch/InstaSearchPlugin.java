...
public final class InstaSearchPlugin extends AbstractUIPlugin {
	...
	/** **/
	public final static String PLUGIN_ID = "com.tlcsdm.eclipse.instasearch";
	...
	private void configureDebug() {
		try {
			...
			debug = debug || java.lang.management.ManagementFactory.getRuntimeMXBean().getInputArguments().toString()
